...
COIN_CONFIGS: Dict[str, dict] = {
    ...
    'BTC/USDT':  dict(d=4.5,  tp=1.5, h=2, f='baseline',      th=0.0,    spd=0.337, rp=True,  rb=240, sl=None, btc_ctx=False),
    'ETH/USDT':  dict(d=5.5,  tp=0.5, h=2, f='decel_gt',      th=0.005,  spd=1.503, rp=True,  rb=240, sl=None, btc_ctx=True),
    'BNB/USDT':  dict(d=4.0,  tp=2.0, h=2, f='baseline',      th=0.0,    spd=3.109, rp=True,  rb=240, sl=None, btc_ctx=True),
    'XRP/USDT':  dict(d=4.0,  tp=1.0, h=2, f='neg_flow60_gt', th=-0.006, spd=0.499, rp=True,  rb=240, sl=None, btc_ctx=True),
    'SOL/USDT':  dict(d=5.0,  tp=0.5, h=2, f='decel_gt',      th=0.005,  spd=0.647, rp=True,  rb=240, sl=None, btc_ctx=True),
    'DOGE/USDT': dict(d=6.0,  tp=0.5, h=2, f='decel_gt',      th=0.015,  spd=1.810, rp=True,  rb=240, sl=None, btc_ctx=True),
    'ADA/USDT':  dict(d=8.0,  tp=1.0, h=2, f='decel_gt',      th=0.02,   spd=3.250, rp=True,  rb=240, sl=None, btc_ctx=True),
    'TRX/USDT':  dict(d=5.0,  tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.257, rp=True,  rb=240, sl=None, btc_ctx=True),
    'AVAX/USDT': dict(d=6.5,  tp=0.5, h=2, f='decel_gt',      th=0.02,   spd=0.724, rp=True,  rb=240, sl=None, btc_ctx=True),
    'LTC/USDT':  dict(d=5.5,  tp=0.5, h=2, f='v60_gt',        th=-0.03,  spd=4.043, rp=True,  rb=240, sl=None, btc_ctx=True),
    # ── Neu in v8 (Top-50 Market Cap, 4J-Backtest 100% WR) ───────────────────────
    'XLM/USDT':  dict(d=7.0,  tp=0.7, h=2,  f='baseline',      th=0.0,    spd=0.015, rp=True,  rb=240, sl=None, btc_ctx=True),
    'SUI/USDT':  dict(d=12.0, tp=1.4, h=2,  f='baseline',      th=0.0,    spd=0.015, rp=True,  rb=240, sl=None, btc_ctx=False),
    'BCH/USDT':  dict(d=10.0, tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.015, rp=True,  rb=240, sl=None, btc_ctx=False),
    'ICP/USDT':  dict(d=12.0, tp=1.0, h=2,  f='close_gt_ma10', th=1.0,    spd=0.015, rp=True,  rb=240, sl=None, btc_ctx=False),

    # ══ STANDARD / SESSION-PEAK COINS ════════════════════════════════════════════
    'RAY/USDT':   dict(d=6.0,  tp=1.5, h=2, f='neg_flow60_gt', th=-0.004, spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'WIF/USDT':   dict(d=10.5, tp=0.5, h=2, f='close_gt_ma10', th=1,      spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'PEPE/USDT':  dict(d=6.0,  tp=1.5, h=2, f='decel_gt',      th=0.015,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=False),
    'PENDLE/USDT':dict(d=7.0,  tp=0.5, h=2, f='speed_z_gt',    th=-2.5,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'INJ/USDT':   dict(d=9.0,  tp=0.5, h=2, f='v60_gt',        th=-0.02,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'RENDER/USDT':dict(d=6.5,  tp=0.5, h=2, f='close_gt_ma10', th=1,      spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'TAO/USDT':   dict(d=6.0,  tp=0.5, h=2, f='close_gt_ma10', th=1,      spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'ALGO/USDT':  dict(d=5.5,  tp=1.5, h=2, f='decel_gt',      th=0.02,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'BONK/USDT':  dict(d=8.5,  tp=0.5, h=2, f='decel_gt',      th=0.02,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'ATOM/USDT':  dict(d=9.5,  tp=0.5, h=2, f='speed_z_gt',    th=-3,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'JASMY/USDT': dict(d=6.5,  tp=0.5, h=2, f='decel_gt',      th=0.01,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'AAVE/USDT':  dict(d=7.5,  tp=1.5, h=2, f='decel_gt',      th=0.015,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'IOTA/USDT':  dict(d=8.0,  tp=0.5, h=2, f='speed_z_gt',    th=-3,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'NEAR/USDT':  dict(d=7.0,  tp=0.5, h=2, f='speed_z_gt',    th=-1,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'DOT/USDT':   dict(d=8.5,  tp=1.8, h=2, f='speed_z_gt',    th=-2.5,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'GALA/USDT':  dict(d=10.5, tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'SHIB/USDT':  dict(d=4.5,  tp=0.5, h=2, f='decel_gt',      th=0,      spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'ONDO/USDT':  dict(d=6.0,  tp=0.5, h=2, f='decel_gt',      th=0.005,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=False),
    'MANA/USDT':  dict(d=9.0,  tp=0.5, h=2, f='speed_z_gt',    th=-3,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'HBAR/USDT':  dict(d=7.5,  tp=0.9, h=2, f='speed_z_gt',    th=-2,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'MOVE/USDT':  dict(d=7.5,  tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'STRK/USDT':  dict(d=5.0,  tp=0.5, h=2, f='decel_gt',      th=0.02,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'ENA/USDT':   dict(d=7.0,  tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'LDO/USDT':   dict(d=8.5,  tp=0.5, h=2, f='decel_gt',      th=0.005,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'IMX/USDT':   dict(d=9.0,  tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.015, rp=False, rb=0, sl=None, btc_ctx=False),
    'FLOKI/USDT': dict(d=6.5,  tp=0.5, h=2, f='decel_gt',      th=0.005,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'UNI/USDT':   dict(d=9.0,  tp=1.9, h=2, f='neg_flow60_gt', th=-0.006, spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'VET/USDT':   dict(d=7.0,  tp=0.5, h=2, f='speed_z_gt',    th=-2.5,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'WLD/USDT':   dict(d=9.0,  tp=0.5, h=2, f='neg_flow60_gt', th=-0.006, spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'CRV/USDT':   dict(d=8.0,  tp=0.6, h=2, f='neg_flow60_gt', th=-0.004, spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'MINA/USDT':  dict(d=6.0,  tp=1.5, h=2, f='neg_flow60_gt', th=-0.004, spd=0.015, rp=False, rb=0, sl=None, btc_ctx=False),
    'FET/USDT':   dict(d=7.0,  tp=0.5, h=2, f='neg_flow60_gt', th=-0.006, spd=0.015, rp=False, rb=0, sl=None, btc_ctx=False),
    'GRT/USDT':   dict(d=6.5,  tp=1.5, h=2, f='speed_z_gt',    th=-1.5,   spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'SAND/USDT':  dict(d=8.5,  tp=0.5, h=2, f='speed_z_gt',    th=-2,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'ORDI/USDT':  dict(d=7.5,  tp=0.5, h=2, f='speed_z_gt',    th=-3,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'LINK/USDT':  dict(d=8.0,  tp=1.5, h=2, f='decel_gt',      th=-0.01,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'STX/USDT':   dict(d=8.0,  tp=1.5, h=2, f='decel_gt',      th=0.015,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'AXS/USDT':   dict(d=7.5,  tp=1.5, h=2, f='v60_gt',        th=-0.04,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=False),
    'OP/USDT':    dict(d=8.5,  tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'TIA/USDT':   dict(d=8.5,  tp=0.5, h=2, f='speed_z_gt',    th=-3,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=False),
    'JUP/USDT':   dict(d=6.0,  tp=0.5, h=2, f='speed_z_gt',    th=-1,     spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'ARB/USDT':   dict(d=8.5,  tp=2.0, h=2, f='decel_gt',      th=-0.01,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    'RUNE/USDT':  dict(d=15.0, tp=0.5, h=2, f='v60_gt',        th=-0.04,  spd=0.015, rp=False, rb=0, sl=None, btc_ctx=True),
    # ++ Neu in v15 (backtest_results_DIP.csv: WR>=90%, trades>=20, PnL>0) ++++++++++++++
    'APT/USDT':     dict(d=12,   tp=1.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'QNT/USDT':     dict(d=8,    tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'SEI/USDT':     dict(d=12,   tp=1.5, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'XTZ/USDT':     dict(d=12,   tp=1.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'FLOW/USDT':    dict(d=10,   tp=0.7, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    # 'EOS/USDT':     dict(d=15,   tp=1.9, h=48, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'NEO/USDT':     dict(d=12,   tp=1.1, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'AR/USDT':      dict(d=12,   tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    ...
    'KAVA/USDT':    dict(d=15,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'CHZ/USDT':     dict(d=12,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'SNX/USDT':     dict(d=15,   tp=1.2, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'ROSE/USDT':    dict(d=9,    tp=1.9, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'DASH/USDT':    dict(d=15,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'ZEC/USDT':     dict(d=15,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'KSM/USDT':     dict(d=15,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'DYDX/USDT':    dict(d=12,   tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'LRC/USDT':     dict(d=15,   tp=1.9, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    '1INCH/USDT':   dict(d=15,   tp=1.6, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'BAT/USDT':     dict(d=12,   tp=1.8, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'QTUM/USDT':    dict(d=15,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    # 'ICX/USDT':     dict(d=12,   tp=0.9, h=48, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'IOTX/USDT':    dict(d=12,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'WOO/USDT':     dict(d=15,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    # 'GLM/USDT':     dict(d=15,   tp=1.9, h=72, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'ANKR/USDT':    dict(d=12,   tp=1.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'ARKM/USDT':    dict(d=15,   tp=1.2, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'SKL/USDT':     dict(d=10,   tp=1.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    # 'FLUX/USDT':    dict(d=9,    tp=1.3, h=120, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'CELO/USDT':    dict(d=12,   tp=0.5, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    # 'AUDIO/USDT':   dict(d=15,   tp=2.0, h=72, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'ZEN/USDT':     dict(d=15,   tp=2.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    # 'DENT/USDT':    dict(d=12,   tp=1.0, h=72, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'NMR/USDT':     dict(d=15,   tp=1.4, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'OGN/USDT':     dict(d=10,   tp=1.0, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
    'POL/USDT':     dict(d=8,    tp=1.9, h=2, f='baseline',      th=0.0,    spd=0.0, rp=False, rb=0, sl=None, btc_ctx=False),
}
